...
const AboutPage = () => {
  ...
  return (
    <>
      <SEO
        title="About Dahla Group | Leading Logistics & Freight Forwarding Company Since 1983"
        description="Learn about Dahla Group, a trusted logistics and freight forwarding company offering air freight, sea freight, and land transport services in UAE and Sudan for over 40 years. Discover our mission, vision, and commitment to excellence in logistics."
        keywords="about Dahla Group, logistics company UAE, freight forwarding company Dubai, logistics provider UAE, freight forwarder history, Dahla Group history, logistics company since 1983, freight forwarding UAE, logistics services Sudan, cargo company UAE, shipping company Dubai, international logistics, freight forwarding services UAE"
        canonical="/about"
